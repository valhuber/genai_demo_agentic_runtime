...
import subprocess
from database.models import SAFRSBaseX, Base
import glob
...
engine = create_engine("sqlite:///" + str(Path(__file__).parent.parent) + "/db_spa.sqlite")
